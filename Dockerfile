...
RUN BUILD_DEPS='build-essential python3-dev' \
    && mkdir -p /var/lib/judge/data/logs /var/lib/judge/data/user_sources /var/lib/judge/data/static /var/lib/judge/data/test_generators /var/lib/judge/data/static/images/avatars \
